                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-4">
                            <div class="flex-1">
                                ...
                                <div class="flex items-start mt-1 mb-2 text-sm text-blue-600 bg-blue-50 p-2 rounded-md">
                                    <svg class="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                    </svg>
                                    <span>Make sure the port is accessible and not blocked by a firewall.</span>
                                </div>
