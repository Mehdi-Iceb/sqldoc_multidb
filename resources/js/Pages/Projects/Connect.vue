                        ...
                        <div class="flex items-center mb-4">
                            <div class="flex-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="absolute right-0 bottom-full mb-2 hidden group-hover:block w-64 p-2 bg-gray-900 text-white text-xs rounded shadow-lg z-10">
                                        Make sure the port is accessible and not blocked by a firewall.
